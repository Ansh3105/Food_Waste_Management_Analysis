...
# Load Data from CSVs
# ---------------------------
claims_df = pd.read_csv("Cleaned(EDA)_Dataset_files/new_claims_data.csv")
food_df = pd.read_csv("Cleaned(EDA)_Dataset_files/new_food_listing_data.csv")
providers_df = pd.read_csv("Cleaned(EDA)_Dataset_files/new_providers_data.csv")
receivers_df = pd.read_csv("Cleaned(EDA)_Dataset_files/new_receivers_data.csv")
