...
# Load Data from CSVs
# ---------------------------
claims_df = pd.read_csv(r"C:\Users\HP\PycharmProjects\Streamlit\Cleaned(EDA)_Dataset_files\new_claims_data.csv")
listing_df = pd.read_csv(r"C:\Users\HP\PycharmProjects\Streamlit\Cleaned(EDA)_Dataset_files\new_food_listing_data.csv")
providers_df = pd.read_csv(r"C:\Users\HP\PycharmProjects\Streamlit\Cleaned(EDA)_Dataset_files\new_providers_data.csv")
receivers_df = pd.read_csv(r"C:\Users\HP\PycharmProjects\Streamlit\Cleaned(EDA)_Dataset_files\new_receivers_data.csv")
...
selected_provider = st.sidebar.selectbox("Select Provider", ["All"] + list(providers))
selected_food_type = st.sidebar.selectbox("Select Food Type", ["All"] + list(food_types))
selected_meal_type = st.sidebar.selectbox("Select Meal Type", ["All"] + list(meal_types))
...
# ---------------------------
# 2. "SQL Query" Results (via Pandas)
# ---------------------------
